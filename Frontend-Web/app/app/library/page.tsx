...
import { Play, Heart, MoreHorizontal, Search, Plus, Clock, Download, Grid3X3, List, Filter } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-400">Your music, playlists, and more</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex border border-rave-dark-border rounded-md">
              <Button
                ...
                className={`rounded-r-none ${viewMode === "grid" ? "bg-rave-dark-surface text-white" : "text-gray-400"}`}
              >
              ...
              <Button
                ...
                className={`rounded-l-none ${viewMode === "list" ? "bg-rave-dark-surface text-white" : "text-gray-400"}`}
              >
        ...
        <Tabs defaultValue="playlists" className="space-y-6">
          <TabsList className="bg-rave-dark-card border-rave-dark-border">
            <TabsTrigger value="playlists" className="data-[state=active]:bg-rave-accent">
              Playlists
            </TabsTrigger>
            <TabsTrigger value="liked" className="data-[state=active]:bg-rave-accent">
              Liked Songs
            </TabsTrigger>
            <TabsTrigger value="recent" className="data-[state=active]:bg-rave-accent">
              Recently Played
            </TabsTrigger>
            <TabsTrigger value="downloads" className="data-[state=active]:bg-rave-accent">
              Downloads
            </TabsTrigger>
          </TabsList>
                ...
                {filteredPlaylists.map((playlist) => (
                  ...
                  >
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-gray-500 text-xs">{playlist.songCount} songs</p>
                        {playlist.isOwner && (
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="hidden md:block text-gray-400 text-sm">{song.dateAdded}</div>
                      <div className="flex items-center gap-2">
                        <Button
                          size="sm"
                          variant="ghost"
          ...
          <TabsContent value="recent" className="space-y-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400">{recentlyPlayed.length} songs</p>
              </div>
            </div>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="hidden md:block text-gray-400 text-sm min-w-0 flex-1">{song.album}</div>
                      <div className="hidden md:block text-gray-400 text-sm">{song.playedAt}</div>
                      <div className="flex items-center gap-2">
                        <span className="text-gray-400 text-sm">{song.duration}</span>
                        <Button
                          size="sm"
          ...
          <TabsContent value="downloads" className="space-y-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Downloaded Music</h2>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="hidden md:block text-gray-400 text-sm min-w-0 flex-1">{song.album}</div>
                      <div className="hidden md:block text-gray-400 text-sm">{song.size}</div>
                      <div className="flex items-center gap-2">
