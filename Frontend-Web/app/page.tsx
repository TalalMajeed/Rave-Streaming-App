...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-rave-dark-bg via-rave-dark-surface to-rave-dark-bg">
                ...
                <div className="container mx-auto text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                            Discover millions of songs, create playlists, and
                            share your favorite tracks with friends. Experience
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/app" className="w-full sm:w-auto">
                                <Button
                                    size="lg"
                                    className="bg-rave-accent hover:bg-rave-accent-hover text-white h-12 w-full sm:w-[200px]"
                                >
                            ...
                            <Link href="#about" className="w-full sm:w-auto">
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="border-gray-600 text-gray-300 hover:bg-gray-800 h-12 w-full sm:w-[200px]"
                                >
                                    Learn More
                                </Button>
                            </Link>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-300 max-w-2xl mx-auto">
                            We're not just another music platform. We're your
                            gateway to musical discovery and connection.
                        </p>
                    </div>
                        ...
                        <Card className="bg-rave-dark-card border-rave-dark-border">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    Access millions of songs from every genre
                                    and era. From chart-toppers to hidden gems.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-rave-dark-card border-rave-dark-border">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    Share playlists, discover what friends are
                                    listening to, and connect through music.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-rave-dark-card border-rave-dark-border">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    AI-powered suggestions that learn your taste
            ...
            <section
                id="contact"
                className="py-20 px-4 bg-rave-dark-surface/30"
            >
                <div className="container mx-auto">
